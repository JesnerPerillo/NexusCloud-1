...
const Card = ({ course, onClick }) => {
  return (
    <div className="p-2 px-5 gap-5 flex mb-10 justify-around flex-col sm:flex-row hover:cursor-pointer" onClick={onClick}>
