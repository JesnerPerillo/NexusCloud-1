    ...
    <div className="w-full min-h-screen con flex flex-col">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-col md:flex-row gap-6 p-5 w-full">
          {/* Admin User List */}
          <div className="w-full md:w-3/5 p-6 rounded-xl shadow-lg border border-gray-300 sidebar">
                  ...
                  {admins.map((admin, index) => (
                    <tr key={index} className="border-t text transition">
                      ...
                      <td className="p-3 flex justify-evenly items-center">
                        <FaEdit className="cursor-pointer text-green-500 h-5 w-5" />
                        <MdDelete className="cursor-pointer text-red-500 h-5 w-5"/>
                      </td>
                    </tr>
                  ))}
                </tbody>
